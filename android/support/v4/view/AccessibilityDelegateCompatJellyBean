...
class AccessibilityDelegateCompatJellyBean {
    ...
    static class C00131 extends AccessibilityDelegate {
        final /* synthetic */ AccessibilityDelegateBridgeJellyBean val$bridge;

        C00131(AccessibilityDelegateBridgeJellyBean accessibilityDelegateBridgeJellyBean) {
